...
| [project-delete-buffers](https://github.com/lem-project/lem/blob/main/src/commands/project.lisp#L209) |              | Delete all this project's buffers, except: if `*delete-repl-buffer*` is non t, we don't delete the REPL buffer, if `*delete-last-buffer*` is non nil, we will delete the last buffer. This would cause Lem to exit.                                                                                                                                                                                                                                             |
