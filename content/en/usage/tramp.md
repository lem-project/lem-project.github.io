...
Lem-tramp is transparent and remote file editing for Lem.
...
Lem-tramp does *not* support:

- accessing directories. Only files.
- hiding passwords when connecting with `/sudo`.
- Windows. This is Unix only.
...
For example:
    ...
    C-x C-f /ssh:debian@1.2.3.4:/home/debian/test.txt
